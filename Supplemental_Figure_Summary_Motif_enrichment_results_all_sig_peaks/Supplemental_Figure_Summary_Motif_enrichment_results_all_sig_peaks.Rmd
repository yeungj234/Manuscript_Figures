...
row.names(Doxo_UpPeaks_AME_mat$vsCycling)[1:40], row.names(Palbo_UpPeaks_AME_mat$vsCycling)[1:25], row.names(Doxo_UpPeaks_AME_mat$vsday3)[1:10], row.names(Palbo_UpPeaks_AME_mat$vsday3)[1:25]))
...
pdf(paste0(outdir, "/UpPeaks_AME_mat.pdf"), width=4.5, height=11)
pheatmap(top35_motifs_Palbo_Doxo_AME_Mat , cluster_rows = T, cluster_cols=F, color = colorRampPalette(c("white",  "#FDBB84", "#B30000"))(100), breaks = seq(0, 200,length.out = 100), main="top 35 enriched motifs in up peaks")
dev.off()

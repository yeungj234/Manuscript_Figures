...
top35_motifs <- unique(c(row.names(Doxo_UpPeaks_AME_mat$vsCycling)[1:60], row.names(Palbo_UpPeaks_AME_mat$vsCycling)[1:35], row.names(Doxo_UpPeaks_AME_mat$vsday3)[1:10], row.names(Palbo_UpPeaks_AME_mat$vsday3)[1:35]))

...
pheatmap(merged_Down_AME_mat, cluster_rows = T, cluster_cols=F, color = colorRampPalette(c("white",  "#FDBB84",  "#EF6548", "#B30000", "#7F0000", "#7F0000"))(100), breaks = seq(0, 30,length.out = 100), main="all down peaks near RNA clusters: enriched motifs, left: Doxo, right: Palbo")

pheatmap(merged_Up_AME_mat, cluster_rows = T, cluster_cols=F, color = colorRampPalette(c("white",  "#FDBB84",  "#EF6548", "#B30000", "#7F0000", "#7F0000"))(100), breaks = seq(0, 30,length.out = 100), main="all up peaks near RNA clusters: enriched motifs, left: Doxo, right: Palbo")
dev.off()
```

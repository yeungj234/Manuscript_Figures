...
pheatmap(GO_results_mat_clusters[[3]][1:5, ], cluster_cols = F, colorRampPalette(brewer.pal(n = 7, name ="Purples"))(100), breaks = seq(0, 20,length.out = 100), cluster_rows = F, main=cluster_names[2], annotation_row=GO_anno, annotation_col = Cluster_anno, annotation_colors = GO_anno_colors, border_color = "black")
dev.off()

pdf(paste0(pdf_dir, "/GO_results_Palbo2_clusters.pdf"), width=5, height=2)
pheatmap(GO_results_mat_clusters[[4]][1:5, ], cluster_cols = F, colorRampPalette(brewer.pal(n = 7, name ="Purples"))(100), breaks = seq(0, 10,length.out = 100), cluster_rows = F, main=cluster_names[3], annotation_row=GO_anno, annotation_col = Cluster_anno, annotation_colors = GO_anno_colors, border_color = "black")
dev.off()

pdf(paste0(pdf_dir, "/GO_results_Doxo1_clusters.pdf"), width=8.5, height=2)
pheatmap(GO_results_mat_clusters[[5]][1:5, ], cluster_cols = F, colorRampPalette(brewer.pal(n = 7, name ="Purples"))(100), breaks = seq(0, 5,length.out = 100), cluster_rows = F, main=cluster_names[4], annotation_row=GO_anno, annotation_col = Cluster_anno, annotation_colors = GO_anno_colors, border_color = "black")
dev.off()

pdf(paste0(pdf_dir, "/GO_results_Doxo2_clusters.pdf"), width=11, height=2)
pheatmap(GO_results_mat_clusters[[6]][1:5, ], cluster_cols = F, colorRampPalette(brewer.pal(n = 7, name ="Purples"))(100), breaks = seq(0, 8,length.out = 100), cluster_rows = F, main=cluster_names[5], annotation_row=GO_anno, annotation_col = Cluster_anno, annotation_colors = GO_anno_colors, border_color = "black")
dev.off()
```

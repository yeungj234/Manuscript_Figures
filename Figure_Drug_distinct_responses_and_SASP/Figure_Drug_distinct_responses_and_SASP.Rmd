...
# plot heatmap of -log10 pvalues of GO enrichment results of sig changing SASP genes
```{r}
...
pdf(paste0(pdf_dir, "/GO_SASP_Palbo1_clusters.pdf"), width=6, height=2)
pheatmap(GO_SASP_mat_clusters[[3]], cluster_cols = F, colorRampPalette(brewer.pal(n = 7, name ="Purples"))(100), breaks = seq(0, 30,length.out = 100), cluster_rows = F, main=cluster_names[3], annotation_row=GO_anno, annotation_col = Cluster_anno, annotation_colors = GO_anno_colors, border_color = "black")
dev.off()

pdf(paste0(pdf_dir, "/GO_SASP_Palbo2_clusters.pdf"), width=13, height=2)
...
pdf(paste0(pdf_dir, "/GO_SASP_Doxo2_clusters.pdf"), width=8.5, height=2)

---
title: "Figure3: p53 activity is different depending on the presence of DNA damage"
author: "Joanna Yeung"
date: '2025-01-24'
...
```{r}
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/GSEA_plots_Hallmark.pdf", width=5, height=4)
GSEA_plots_H
dev.off()
```
...
for(i in 1:length(genes_in_clusters)){
  ...
  write.table(IPA_input, file=paste0("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/IPA_files/", cluster_names[i], ".csv"), row.names=F, sep=",")
}
# DESeq Wald Test results for pairwise comparisons. 
for(i in 1:length(LFCResultsall_RNA)){
  write.table(as.data.frame(LFCResultsall_RNA[[i]]), file=paste0("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/IPA_files/DESeq_results_input/", names(LFCResultsall_RNA)[i], ".csv"), sep=",")
}
```

# # RNA-seq: import IPA upstream regulators & pathways
```{r}
setwd("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/IPA_files/output/")
...
write.csv(NormCountsMat, file="/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Supplemental_Tables/RNA_NormalizedCounts.csv")
...
export.bed(p53_ATAC_Up_DrugandArrestCat[[i]], con = paste0("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/input_beds/", names(p53_ATAC_Up_DrugandArrestCat)[i], "_p53_HMv11.bed"))
}

for(i in 1:length(p53_ATAC_Up_DrugandArrest_PvsD)){
export.bed(p53_ATAC_Up_DrugandArrest_PvsD[[i]], con = paste0("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/input_beds/", names(p53_ATAC_Up_DrugandArrest_PvsD)[i], "_PvsD_p53_HMv11.bed"))
}

# generate input files for deepTools scripts
# directory paths to bed files 
writeLines(dir("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/input_beds", full.names=T, pattern=".bed"), con="/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/input_beds/regions.txt")

# filenames to be assigned to plots. 
filenames <- gsub(".bed", "", dir("//lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/input_beds", pattern=".bed"))
writeLines(filenames, con="/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/input_beds/filename.txt")
```
...
cd /lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/output_plots
sbatch -p risc,hpc --array=1-10 \
--export=bigwigs="$mergedcuts",\
regions=/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/input_beds/regions.txt,\
samplenames="$samplenames",\
profile_outdir=/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/output_plots/plotProfile,\
heatmap_outdir=/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/output_plots/plotHeatmap,\
filename=/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/input_beds/filename.txt \
/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/deeptools_Coverage_1kb.slurm
```
...
export.bed(JUNB_ATAC_Up_DrugandArrestCat[[i]], con = paste0("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/input_beds/", names(JUNB_ATAC_Up_DrugandArrestCat)[i], "_JUNB_HMv11.bed"))
}

for(i in 1:length(JUNB_ATAC_Up_DrugandArrest_PvsD)){
export.bed(JUNB_ATAC_Up_DrugandArrest_PvsD[[i]], con = paste0("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/input_beds/", names(JUNB_ATAC_Up_DrugandArrest_PvsD)[i], "_PvsD_JUNB_HMv11.bed"))
}

# generate input files for deepTools scripts
# directory paths to bed files 
regions <- dir("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/input_beds", full.names=T, pattern=".bed")
regions <- regions[grepl("JUNB", regions)]
writeLines(regions, con="/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/deepTools_files/input_beds/regions.txt")
...
library(enrichplot)
library(patchwork)
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/GSEA_day14Doxo_vs_Cyc_Hallmark_p53_pathway.pdf", width=3, height=2.5)
...
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/GSEA_day14Doxo_day14Palbo_vs_Cyc_Hallmark_p53_pathway.pdf", width=3, height=5)
...
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/RNA_log2FC_p53_Hallmark_mat.pdf", width=5, height=3.5)
...
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/RNA_p53vsNFKB_genes_vennDiagram.pdf", width=4, height=4)
...
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/RNA_log2FC_p53_targets.pdf", width=7, height=3)
library(ggbeeswarm)
create_violin_plot(
...
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/RNA_day3_log2FC_p53_targets.pdf", width=4, height=3)
library(ggbeeswarm)
create_violin_plot(
...
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/RNA_day14_log2FC_p53_targets.pdf", width=4, height=3)
library(ggbeeswarm)
create_violin_plot(
...
# save plot to pdf
pdf(file="/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/RNA_NormCountsMat_MDM2_CDKN1A.pdf", width=8, height=2)
...
```{r}
outdir <- "/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3"
library(seqLogo)
...
# for thesis, plot RNA norm counts of EPAS1, ANGPTL4, IL1R1 and TLR4
```{r}
NormCounts_df$Timepoint <- as.numeric(as.character(NormCounts_df$Timepoint))
# save plot to pdf
pdf(file="/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/RNA_NormCountsMat_ANGPTL4_EPAS1_IL1R1_TLR4.pdf", width=8, height=6)

ggplot(NormCounts_df[NormCounts_df$Transcript %in% c("EPAS1", "ANGPTL4", "IL1R1", "TLR4"), ], aes(x=Timepoint, y=Counts, color=Treatment, shape=Biorep))+geom_point(size=3)+facet_wrap(~Transcript, scales="free")+scale_color_manual(values=hm_cols_RNA$Treatment)+theme_minimal()+ylab("Normalized Counts")+xlab("Length of Treatment (days)")+ggtitle("")+scale_y_continuous(n.breaks=5)+scale_x_continuous(n.breaks=5)+theme_classic()+theme(
      axis.text.x = element_text(size = 8),
      axis.text.y = element_text(size = 8),
      axis.title.y = element_text(size = 10), 
      axis.title.x = element_text(size = 10)
...
pdf(file="/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/RNA_NormCountsMat_TNC_LUM_VCAN_TLR4.pdf", width=8, height=6)

ggplot(NormCounts_df[NormCounts_df$Transcript %in% c("TNC", "LUM", "VCAN", "TLR4"), ], aes(x=Timepoint, y=Counts, color=Treatment, shape=Biorep))+geom_point(size=3)+facet_wrap(~Transcript, scales="free")+scale_color_manual(values=hm_cols_RNA$Treatment)+theme_minimal()+ylab("Normalized Counts")+xlab("Length of Treatment (days)")+ggtitle("")+scale_y_continuous(n.breaks=5)+scale_x_continuous(n.breaks=5)+theme_classic()+theme(
      axis.text.x = element_text(size = 8),
      axis.text.y = element_text(size = 8),
      axis.title.y = element_text(size = 10), 
      axis.title.x = element_text(size = 10)
...
# for thesis, plot RNA norm counts of IL1A, IL1B, CXCL1, CXCL6, CXCL8, CSF2, SOD2, IL6, IL37
```{r}
NormCounts_df$Timepoint <- as.numeric(as.character(NormCounts_df$Timepoint))
# save plot to pdf
pdf(file="/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure5/RNA_NormCountsMat_sharedSASP.pdf", width=8, height=6)

ggplot(NormCounts_df[NormCounts_df$Transcript %in% c("IL1A", "IL1B", "CXCL1", "CXCL8", "CSF2", "SOD2", "IL6", "IL3"), ], aes(x=Timepoint, y=Counts, color=Treatment, shape=Biorep))+geom_point(size=3)+facet_wrap(~Transcript, scales="free")+scale_color_manual(values=hm_cols_RNA$Treatment)+theme_minimal()+ylab("Normalized Counts")+xlab("Length of Treatment (days)")+ggtitle("")+scale_y_continuous(n.breaks=5)+scale_x_continuous(n.breaks=5)+theme_classic()+theme(
      axis.text.x = element_text(size = 8),
      axis.text.y = element_text(size = 8),
      axis.title.y = element_text(size = 10), 
      axis.title.x = element_text(size = 10)
...
ggplot(NormCounts_df[NormCounts_df$Transcript %in% c("RELA", "REL", "RELB", "NFKB1", "NFKB2", "NFKBIA", "NFKBIB", "NFKBID", "NFKBIE", "NFKBIL1", "NFKBIZ"), ], aes(x=Timepoint, y=Counts, color=Treatment, shape=Biorep))+geom_point(size=3)+facet_wrap(~Transcript, scales="free")+scale_color_manual(values=hm_cols_RNA$Treatment)+theme_minimal()+ylab("Normalized Counts")+xlab("Length of Treatment (days)")+ggtitle("")+scale_y_continuous(n.breaks=5)+scale_x_continuous(n.breaks=5)+theme_classic()+theme(
      axis.text.x = element_text(size = 8),
      axis.text.y = element_text(size = 8),
      axis.title.y = element_text(size = 10), 
      axis.title.x = element_text(size = 10)
...
pdf(file="/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure4/RNA_NormCountsMat_TGFB.pdf", width=11, height=6)
ggplot(NormCounts_df[grepl("TGFB[0-9]$|TGFBR[0-9]$", NormCounts_df$Transcript), ], aes(x=Timepoint, y=Counts, color=Treatment, shape=Biorep))+geom_point(size=3)+facet_wrap(~Transcript, scales="free")+scale_color_manual(values=hm_cols_RNA$Treatment)+theme_minimal()+ylab("Normalized Counts")+xlab("Length of Treatment (days)")+ggtitle("")+scale_y_continuous(n.breaks=5)+scale_x_continuous(n.breaks=5)+theme_classic()+theme(
      axis.text.x = element_text(size = 8),
      axis.text.y = element_text(size = 8),
      axis.title.y = element_text(size = 10), 
      axis.title.x = element_text(size = 10)
...
# check linker histone H1 levels b/c I'm curious
```{r}
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure3/RNA_NormCountsMat_LinkerHistone.pdf", height=5)
ggplot(NormCounts_df[grepl("^H1-[0-9]$|^H1-10$", NormCounts_df$Transcript), ], aes(x=Timepoint, y=Counts, color=Treatment, shape=Biorep))+geom_point(size=3)+facet_wrap(~Transcript, scales="free")+scale_color_manual(values=hm_cols_RNA$Treatment)+theme_minimal()+ylab("Normalized Counts")+xlab("Length of Treatment (days)")+ggtitle("")+scale_y_continuous(n.breaks=5)+scale_x_continuous(n.breaks=5)+theme_classic()+theme(
      axis.text.x = element_text(size = 8),
      axis.text.y = element_text(size = 8),
      axis.title.y = element_text(size = 10), 
      axis.title.x = element_text(size = 10)

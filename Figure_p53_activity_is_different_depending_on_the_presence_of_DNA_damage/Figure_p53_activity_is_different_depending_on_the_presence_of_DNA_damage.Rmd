...
for(i in 1:length(GO_enrichment_clusters_REACT)){
  GO_enrichment_clusters_KEGG_df[[i]] <- as.data.frame(GO_enrichment_clusters_REACT[[i]])
...
GO_results_list$CellCycle1 <- rbind(GO_enrichment_clusters_KEGG_df$CellCycle1, GO_enrichment_clusters_HallMark_df$CellCycle1, GO_enrichment_clusters_REACT_df$CellCycle1, GOBP_enrichment_clusters_df$CellCycle1)

GO_results_list$CellCycle2 <- rbind(GO_enrichment_clusters_KEGG_df$CellCycle2, GO_enrichment_clusters_HallMark_df$CellCycle2, GO_enrichment_clusters_REACT_df$CellCycle2, GOBP_enrichment_clusters_df$CellCycle2)
...
GO_anno_colors <-  list(database=c("GO:BP"="#3B4992FF", "Hallmark"="#EE0000FF", "KEGG"="#008B45FF", "REACTOME" ="#631879FF"), Cluster=c("CellCycle1"="#66C2A5", "CellCycle2"="#A6D854", "Palbo1"="#FC8D62", "Palbo2"="#8DA0CB","Doxo1"="#E78AC3","Doxo2"="#FFD92F", "Shared"="#E5C494"))

...
# ATAC-seq: plot log2FC of NF-kB target genes at day 3 & 14 timepoints relative to Cycling but break it up by the RNA cluster that the gene belongs to (more accurately showing shared upregulated NF-kB target genes response)
...
```{r}
# note: after talking with Justin, do paired t-test for all log2FC distribution comparisons. Overall, log2FC distribution of all genes follows a normal distribution so if I break it up by different types of transcription factor targets, it comes from an overall normal distribution. 

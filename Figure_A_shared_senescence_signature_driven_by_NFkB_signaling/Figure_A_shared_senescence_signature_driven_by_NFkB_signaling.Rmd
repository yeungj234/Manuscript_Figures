...
```{r}
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure_A_shared_senescence_signature_driven_by_NFkB_signaling/GSEA_Hallmark_TNFA SIGNALING VIA NFKB_pathway.pdf", width=3, height=2.5)
GSEA_plots_H$`Doxo10 vs Doxo3`$`TNFA SIGNALING VIA NFKB`+theme_classic()+ylim(-0.05,0.7)
GSEA_plots_H$`Doxo14 vs Doxo3`$`TNFA SIGNALING VIA NFKB`+theme_classic()+ylim(-0.05,0.7)
GSEA_plots_H$`Doxo21 vs Doxo3`$`TNFA SIGNALING VIA NFKB`+theme_classic()+ylim(-0.05,0.7)

GSEA_plots_H$`Palbo10 vs Palbo3`$`TNFA SIGNALING VIA NFKB`+theme_classic()+ylim(-0.05,0.7)
GSEA_plots_H$`Palbo14 vs Palbo3`$`TNFA SIGNALING VIA NFKB`+theme_classic()+ylim(-0.05,0.7)
GSEA_plots_H$`Palbo21 vs Palbo3`$`TNFA SIGNALING VIA NFKB`+theme_classic()+ylim(-0.05,0.7)
GSEA_plots_H$`Palbo28 vs Palbo3`$`TNFA SIGNALING VIA NFKB`+theme_classic()+ylim(-0.05,0.7)
dev.off()
```

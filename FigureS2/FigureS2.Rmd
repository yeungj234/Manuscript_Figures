---
title: "Figure S2: The shutdown of E2F target genes is more efficient with direct CDK4/6 inhibition, related to Figure 2"
author: "Joanna Yeung"
date: '2025-01-27'
...
```{r}
run_code_chunk(Rmd_file="/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure4/Figure4.Rmd", chunk_name="import IPA results")

run_code_chunk(Rmd_file="/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/Figure4/Figure4.Rmd", chunk_name="IPA results matrix")
```
...
directory <- "/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/deepTools_files/input_beds"
...
cd /lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/deepTools_files/output_plots
sbatch -p risc,hpc --array=1-10 \
--export=bigwigs="$mergedcuts",\
regions=/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/deepTools_files/input_beds/regions.txt,\
samplenames="$samplenames",\
profile_outdir=/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/deepTools_files/output_plots/plotProfile,\
heatmap_outdir=/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/deepTools_files/output_plots/plotHeatmap,\
filename=/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/deepTools_files/input_beds/filename.txt \
/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/deepTools_files/deeptools_Coverage_1kb.slurm
```
...
```{r}
input_dir <- "/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS3/motif_analysis_output/DESeq/annoDown"

out_dir <- "/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/E2F_tp_peaks"
...
```{bash}
cd /lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/E2F_tp_peaks

# for all E2F motifs
sbatch -p risc --array=1-16 \
--export=outdir=/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/E2F_tp_peaks/all_E2F_motifs,\
inputfiles=/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/E2F_tp_peaks/DESeq_annoDown_sequencefiles.txt,\
names=/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS3/motif_analysis_input/DESeq/annoDown/folderlist_annoDown_DESeq_peaks.txt,\
motif=E2F \
...
# for E2F1 motif
sbatch -p risc --array=1-16 \
--export=outdir=/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/E2F_tp_peaks/E2F1_motif,\
inputfiles=/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/E2F_tp_peaks/DESeq_annoDown_sequencefiles.txt,\
names=/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS3/motif_analysis_input/DESeq/annoDown/folderlist_annoDown_DESeq_peaks.txt,\
motif=E2F1 \
get_tp_peaks_motifs.slurm
...
setwd("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/E2F_tp_peaks/all_E2F_motifs")
...
setwd("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/E2F_tp_peaks/E2F1_motif")
...
```{r}
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/GSEA_Hallmark_E2F_TARGETS_pathway.pdf", width=3, height=2.5)
...
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2//GSEA_day14Doxo_day14Palbo_vs_Cyc_Hallmark_E2F_Targets.pdf", width=3, height=5)
...
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/RNA_GO_results_SharedDown_genes.pdf", width=6, height=2.5)
...
# make heatmap of top 5 IPA predicted upstream regulators for shared down genes. 
pdf(file="/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/RNA_IPA_TF_regs_SharedDown_genes.pdf", width=3, height=2)
...
pdf(file="/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/RNA_IPA_group_regs_SharedDown_genes.pdf", width=3.8, height=2)
...
```{r}
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/RNA_log2FC_E2F_targets_mat.pdf", width=4.35, height=6)
...
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/RNA_log2FC_E2F_targets.pdf", width=7, height=3)
library(ggbeeswarm)
create_violin_plot(
  data = log2FC_E2F,
...
pdf("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2/RNA_log2FC_day14_E2F_targets.pdf", width=4, height=3)
library(ggbeeswarm)
create_violin_plot(
...
load("/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS3/Functions/create_AME_dotplots.RData")
...
outdir <- "/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2"
...
# ATAC-seq: make sequence Logo from HOCOMOCO E2F motifs
```{r}
outdir <- "/lustre/fs4/risc_lab/scratch/jyeung/Manuscript_Figures/FigureS2"
# load in HOCOMOCO motif sequence database
load("/lustre/fs4/risc_lab/scratch/jyeung/LS_PDvsDoxo_2/ATACseq/post_peakcalling_analysis/motifs/HOCOMOCO_v11_matrix.RData")
library(seqLogo)
pdf(paste0(outdir, "/E2F_HUMAN_HOCOMOCO_seqLogo.pdf"), width=6, height=4)
seqLogo(HOCOMOCO_v11_matrix$E2F1_HUMAN.H11MO.0.A)
seqLogo(HOCOMOCO_v11_matrix$E2F2_HUMAN.H11MO.0.B)
seqLogo(HOCOMOCO_v11_matrix$E2F3_HUMAN.H11MO.0.A)
seqLogo(HOCOMOCO_v11_matrix$E2F4_HUMAN.H11MO.0.A)
seqLogo(HOCOMOCO_v11_matrix$E2F4_HUMAN.H11MO.1.A)
seqLogo(HOCOMOCO_v11_matrix$E2F5_HUMAN.H11MO.0.B)
seqLogo(HOCOMOCO_v11_matrix$E2F6_HUMAN.H11MO.0.A)
seqLogo(HOCOMOCO_v11_matrix$E2F7_HUMAN.H11MO.0.B)
dev.off()
```
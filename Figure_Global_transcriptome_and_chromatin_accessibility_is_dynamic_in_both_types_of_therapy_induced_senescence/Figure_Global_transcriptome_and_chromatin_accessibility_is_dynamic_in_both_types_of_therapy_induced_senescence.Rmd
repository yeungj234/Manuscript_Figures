...
clusterDF <- as.data.frame(factor(k$kmeans$cluster, levels=c(2,5,7,1,4,6,3)))
colnames(clusterDF) <- "Clusters"
row.names(clusterDF) <- make.unique(names(factor(k$kmeans$cluster, levels=c(2,5,7,1,4,6,3))))
...
drug_cat_list <- list(sigMat[row.names(sigMat) %in% row.names(clusterDF[clusterDF$Clusters %in% "2", ]), ], 
                      sigMat[row.names(sigMat) %in% row.names(clusterDF[clusterDF$Clusters %in% "5", ]), ], 
                      ...
                      sigMat[row.names(sigMat) %in% row.names(clusterDF[clusterDF$Clusters %in% "4", ]), ],
                      sigMat[row.names(sigMat) %in% row.names(clusterDF[clusterDF$Clusters %in% "6", ]), ],

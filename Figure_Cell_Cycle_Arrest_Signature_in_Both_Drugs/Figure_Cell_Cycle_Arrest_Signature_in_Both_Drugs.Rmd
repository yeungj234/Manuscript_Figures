...
p1 <- gseaplot(GSEA_Results_H$`Doxo14 vs Cycling0`, geneSetID = "E2F TARGETS", by="runningScore", title = "day 14 Doxo vs Cycling: E2F TARGETS", color.line="#B3C543", color="#B3C543")+theme_classic()+ylim(-0.9, 0.05)

p2 <- gseaplot(GSEA_Results_H$`Palbo14 vs Cycling0`, geneSetID = "E2F TARGETS", by="runningScore", title = "day 14 Palbo vs Cycling: E2F TARGETS", color="#E0ADCD", color.line="#E0ADCD")+theme_classic()+ylim(-0.9, 0.05)
